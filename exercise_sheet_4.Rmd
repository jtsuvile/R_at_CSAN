...
Q4.3.5 Pick the better model of the two and make a nice table presentation of it using the `apa.reg.table()` function from the apaTables package. You only need to give it the variable where you stored your model result as an input.
