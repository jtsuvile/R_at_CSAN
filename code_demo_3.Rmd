...
# NB: Note: A more recent version of tidyverse includes functions pivot_wider and pivot_longer, which are recommended for use instead of spread and gather, respectively. You can choose to use either! To get the same end result as above with pivot_longer, you would run

data_long2 <- data %>% pivot_longer(cols=Partner:M_Stranger, names_to='person', values_to='emotional_bond')
