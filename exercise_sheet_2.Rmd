...
* [You can see the solutions for the exercises below here](./solutions_exercise_2.html){target="_blank"} (but do try to solve the tasks with help from the demo code and google before looking at solutions)
